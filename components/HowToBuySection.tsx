  ...
  const steps = [
    {
      num: '01',
      title: 'Выбор трека',
      desc: 'Послушайте готовые песни в каталоге или закажите песню под ключ, предоставив референсы.'
    },
    {
      num: '02',
      title: 'Обсуждение',
    ...
    },
    {
      ...
      desc: 'Заключаем лицензионный договор, после чего вы производите оплату.'
    },
    {
      num: '04',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[#94A3B8] text-lg max-w-2xl mx-auto font-medium">
            Всего 4 простых шага отделяют вас от получения полностью готового трека.
          </p>
        </div>
